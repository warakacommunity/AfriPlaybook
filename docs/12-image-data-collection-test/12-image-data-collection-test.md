---
sidebar_position: 1
sidebar_label: "12. Image Data Collection [TEST]"
---

# 12. Image Data Collection [TEST]
...
![Title: Eight-step image data collection pipeline - Description: Eight-step image data collection pipeline](images/12-image-data-collection-test-gktm6wb54.gif)
...
![Title: Collection yield funnel from raw to annotation-ready - Description: Collection yield funnel from raw to annotation-ready](images/12-image-data-collection-test-1g82v3enss.gif)
...
![Title: Annotation and QA loop - Description: Annotation and QA loop](images/12-image-data-collection-test-auapqy99w.gif)
